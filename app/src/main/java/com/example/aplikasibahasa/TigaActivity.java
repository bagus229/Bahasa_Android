...
public class TigaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.indonesiasatu);
        ...
        iconHome.setOnClickListener(v -> {
            Intent home = new Intent(TigaActivity.this, HomeActivity.class);
            startActivity(home);
        });
    ...
    void cekJawaban(int pilihan) {
        if (pilihan == kunci[indexSoal]) {
            Intent i = new Intent(TigaActivity.this, EmpatActivity.class);
            startActivity(i);
        } else {
