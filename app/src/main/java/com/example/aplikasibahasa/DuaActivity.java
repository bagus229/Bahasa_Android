...
public class DuaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inggrisdua);
        ...
        iconHome.setOnClickListener(v -> {
            Intent home = new Intent(DuaActivity.this, HomeActivity.class);
            startActivity(home);
        });
    ...
    void cekJawaban(int pilihan) {
        if (pilihan == kunci[indexSoal]) {
            Intent i = new Intent(DuaActivity.this, BerhasilActivity.class);
            startActivity(i);
        } else {
