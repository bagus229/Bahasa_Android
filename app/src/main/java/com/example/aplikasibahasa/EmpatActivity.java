...
public class EmpatActivity extends AppCompatActivity {
    ...
    String[] soals = {"lari", "Makan", "Lompat"};
    String[] jawabanA = {"Run", "Eat", "Jump"};
    String[] jawabanB = {"Eat", "Drink", "Walk"};
    int[] kunci = {1, 1, 1};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.indonesiadua);
        ...
        iconHome.setOnClickListener(v -> {
            Intent home = new Intent(EmpatActivity.this, HomeActivity.class);
            startActivity(home);
        });
    ...
    void cekJawaban(int pilihan) {
        if (pilihan == kunci[indexSoal]) {
            Intent i = new Intent(EmpatActivity.this, BerhasilActivity.class);
            startActivity(i);
        } else {
